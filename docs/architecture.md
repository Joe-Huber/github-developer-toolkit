...
run against deterministic data. The corpus is generated by a script and pinned
by contract tests. See the [testing & fixtures guide](testing.md) for the corpus
format, the profile scenarios it covers, and how to regenerate it.
